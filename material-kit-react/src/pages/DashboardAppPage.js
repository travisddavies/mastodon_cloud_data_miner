...
export default function DashboardAppPage() {
  ...
  useEffect(() => {
    axios.get('http://172.26.135.191/api/tweet_number')
      .then(response => {
    ...
    axios.get('http://172.26.135.191/api/topic_climate_number')
      .then(response => {
    ...
    axios.get('http://172.26.135.191/api/emoji_usage')
      .then(response => {
    ...
    axios.get('http://172.26.135.191/api/topic_coffee_number')
      .then(response => {
  ...
  useEffect(() => {
      axios.get('http://172.26.135.191/api/state_tweet_count')
        .then(response => {
