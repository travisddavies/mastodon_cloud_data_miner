...
export const processData = async () => {
  try {
    const responseClimate = await axios.get('http://localhost:5000/topic_climate');
    const responseTotal = await axios.get('http://localhost:5000/state_tweet_count');
    const responseEnv = await axios.get('http://localhost:5000/environment_sudo');
